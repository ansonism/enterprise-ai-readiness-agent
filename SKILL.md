# SKILL.md — Enterprise AI Readiness Agent
...
- Delivery/DevSecOps/MLOps maturity
- AI use-case portfolio and economics
- Observability, evaluation and incident practices

    ## 4. Required outputs

    - Domain readiness scores with evidence
- Overall maturity level
- Critical blockers
- Prioritized capability backlog
- 30/60/90-day actions
- 12-month roadmap
- Executive summary and investment themes
...
- `roadmap_builder`
    ...
    - 1. `ingest_assessment_evidence`
- 2. `score_readiness_domains`
- 3. `validate_scores_against_evidence`
- 4. `identify_blockers_and_dependencies`
- 5. `prioritize_use_cases_and_foundations`
- 6. `build_target_maturity_profile`
- 7. `generate_30_60_90_and_12_month_roadmap`
- 8. `produce_executive_assessment`
    ...
    Maintain a provider-neutral interface in `src/ai_readiness/providers/base.py`.
