...
from ai_readiness.models import EvidenceInput, ReadinessAssessmentInput, RunStatus
from ai_readiness.persistence import InMemoryRunStateRepository
from ai_readiness.providers.mock import MockProvider
from ai_readiness.workflow import DEFAULT_STAGES, Workflow

NOW = datetime(2026, 1, 1, tzinfo=UTC)


def request() -> ReadinessAssessmentInput:
